...
// Define template images based on template_id
$template_images = [
    1 => 'templates/template1.jpg',
    2 => 'templates/template2.jpg',
    3 => 'templates/template3.jpg',
    4 => 'templates/template4.jpg'
];

// Check if the template_id is valid; if not, default to 1
$template_image = isset($template_images[$template_id]) ? $template_images[$template_id] : $template_images[1];
?>
...
<body>
    <div class="container">
        ...
        <div class="template-preview" id="image">
            <img src="<?= htmlspecialchars($template_image) ?>" alt="Template Image">
