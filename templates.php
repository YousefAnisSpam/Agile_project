    ...
    <div class="container">
        ...
        <div class="template-grid">
            ...
            <div class="template-item">
                ...
                <a class="template-link" href="edit_template2.php?template=2">Select Template 2</a>
            </div>
            <div class="template-item">
                <img src="<?php echo $imagep_3; ?>" alt="Template 3">
                <a class="template-link" href="edit_template3.php?template=3">Select Template 3</a>
            </div>
            <div class="template-item">
                <img src="<?php echo $imagep_4; ?>" alt="Template 4">
                <a class="template-link" href="edit_template4.php?template=4">Select Template 4</a>
            </div>
        </div>
